                    ...
                    <div className="grid grid-cols-1 text-center mt-10 relative">
                        ...
                        <div className="d-flex" id="reserve-form">
                            ...
                            <div className="absolute top-3/4 start-1">
                                <div className="size-10 bg-white dark:bg-slate-900 flex items-center justify-center shadow-sm shadow-gray-200 dark:shadow-gray-700 rounded-md">
                                    <img src={lenovo_logo} className="size-6" alt="" />
                                </div>
                            </div>

                            <div className="absolute top-3/4 end-10">
                                <div className="size-10 animate-[spin_5s_linear_infinite] bg-white dark:bg-slate-900 flex items-center justify-center shadow-sm shadow-gray-200 dark:shadow-gray-700 rounded-md">
                                    <img src={skype} className="size-6" alt="" />
                                </div>
                            </div>

                            <div className="absolute -bottom-32 start-1/2 -translate-x-1/2">
                                <div className="size-10 animate-pulse bg-white dark:bg-slate-900 flex items-center justify-center shadow-sm shadow-gray-200 dark:shadow-gray-700 rounded-md">
                                    <img src={snapchat} className="size-6" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
