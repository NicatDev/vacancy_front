                ...
                <div className="container md:mt-24 mt-16">
                    ...
                    <div className="lg:flex justify-center mt-8">
                        <div className="lg:w-3/4">
                            <div className="group md:flex items-center justify-between p-6 rounded-lg shadow-sm hover:shadow-lg shadow-gray-200 dark:shadow-gray-700 transition-all duration-500">
                                <div>
                                ...
                                <Link to="/job-detail-one" className="py-1 px-5 inline-block font-semibold tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-full bg-transparent group-hover:bg-emerald-600 border border-slate-100 dark:border-slate-800 text-slate-400 group-hover:text-white md:mt-0 mt-4">Apply now</Link>
                            </div>

                            <div className="group md:flex items-center justify-between p-6 rounded-lg shadow-sm hover:shadow-lg shadow-gray-200 dark:shadow-gray-700 transition-all duration-500 mt-6">
                                <div>
