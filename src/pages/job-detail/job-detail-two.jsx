                ...
                <div className="container mt-10">
                    <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                        <div className="lg:col-span-8 md:col-span-6">
                            <div className="md:flex items-center p-6 shadow-sm shadow-gray-200 dark:shadow-gray-700 rounded-md bg-white dark:bg-slate-900">
                                ...
                                <div className="md:ms-4 md:mt-0 mt-6">
                                    <h5 className="text-xl font-semibold">{data?.heading ? data?.heading :'Back-End Developer'}</h5>
                                    <div className="mt-2">
                        ...
                        <div className="lg:col-span-4 md:col-span-6">
                            <div className="shadow-sm shadow-gray-200 dark:shadow-gray-700 rounded-md bg-white dark:bg-slate-900 sticky top-20">
                                <div className="p-6">
