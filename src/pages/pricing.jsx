            ...
            <section className="relative lg:py-24 py-16">
                <div className="container">
                    <div className="grid md:grid-cols-3 grid-cols-1 gap-[30px]">
                        <div className="group border border-transparent relative shadow-sm hover:shadow-md dark:shadow-gray-800 rounded-md bg-white dark:bg-slate-900 transition-all duration-500">
                            <div className="p-6 py-8">
                                ...
                                <Link to="#" className="py-1 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-md mt-5">Get Started</Link>
                            </div>
                        </div>

                        <div className="group border border-emerald-600 relative shadow-sm hover:shadow-md dark:shadow-gray-800 rounded-md z-2 bg-gray-50 dark:bg-slate-800 transition-all duration-500">
                            <div className="p-6 py-8">
                                ...
                                <Link to="#" className="py-1 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-md mt-5">Signup</Link>
                            </div>
                        </div>

                        <div className="group border border-transparent relative shadow-sm hover:shadow-md dark:shadow-gray-800 rounded-md z-2 bg-white dark:bg-slate-900 transition-all duration-500">
                            <div className="p-6 py-8">
                                ...
                                <Link to="#" className="py-1 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-md mt-5">Try it Now</Link>
                            </div>
                        </div>
                    </div>
                </div>
