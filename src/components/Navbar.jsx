    ...
    return (
        <nav id="topnav" className={`defaultscroll is-sticky ${topnavClass}`}>
            <div className={`${isContainerFluid === true ? 'container-fluid md:px-8 px-3' : 'container'}`}>
                ...
                <ul className="buy-button list-none mb-0">
                    <li className="inline-block mb-0">
                        <div className="relative top-[3px]">
                            ...
                            <input type="text" className="py-2 px-3 text-[14px] border border-gray-100 dark:border-gray-800 dark:text-slate-200 outline-none h-9 !pe-10 rounded-3xl sm:w-44 w-36 bg-white dark:bg-slate-900" name="s" id="searchItem" placeholder="Search..." />
                        </div>
                    </li>

                    <li className="dropdown inline-block relative ps-1">
                        <button onClick={() => openDropdown(!isDropdown)} data-dropdown-toggle="dropdown" className="dropdown-toggle items-center" type="button">
                        ...
                        <div className={`dropdown-menu absolute end-0 m-0 mt-4 z-10 w-44 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow-sm shadow-gray-200 dark:shadow-gray-700 ${isDropdown ? 'hidden' : 'block'}`} >
                            <ul className="py-2 text-start">
                                <li>
                                    <Link to="/candidate-profile" className="flex items-center font-medium py-2 px-4 dark:text-white/70 hover:text-emerald-600 dark:hover:text-white"><FiUser className="size-4 me-2" />Profile</Link>
                                </li>
                                <li>
                                    <Link to="/candidate-profile-setting" className="flex items-center font-medium py-2 px-4 dark:text-white/70 hover:text-emerald-600 dark:hover:text-white"><FiSettings className="size-4 me-2" />Settings</Link>
                                </li>
                                <li className="border-t border-gray-100 dark:border-gray-800 my-2"></li>
                                <li>
                                    <Link to="/lock-screen" className="flex items-center font-medium py-2 px-4 dark:text-white/70 hover:text-emerald-600 dark:hover:text-white"><FiLock className="size-4 me-2" />Lockscreen</Link>
                                </li>
                                <li>
                                    <Link to="/login" className="flex items-center font-medium py-2 px-4 dark:text-white/70 hover:text-emerald-600 dark:hover:text-white"><FiLogOut className="size-4 me-2" />Logout</Link>
                                </li>
                            </ul>
                        </div>
                    </li>
                ...
                <div id="navigation" className={`${isOpen === true ? '!hidden-md block' : '!block'}`}>
                    <ul className={`navigation-menu ${navClass}`}>
                        <li className="has-submenu parent-menu-item">
                            ...
                            <ul className="submenu">
                                ...
                                <li><Link to="/index-eight" className="sub-menu-item">Hero Eight</Link></li>
                                <li><Link to="/index-nine" className="sub-menu-item">Hero Nine</Link></li>
                                <li><Link to="/index-ten" className="sub-menu-item">Hero Ten </Link></li>
                            </ul>
                        </li>
                        ...
                        <li className="has-submenu parent-parent-menu-item">
                            ...
                            <ul className="submenu">
                                ...
                                <li className="has-submenu parent-menu-item">
                                    <Link to="#">Candidates </Link><span className="submenu-arrow"></span>
                                    <ul className="submenu">
                                        ...
                                        <li><Link to="/candidate-profile-setting" className="sub-menu-item">Profile Settings </Link></li>
                                    </ul>
                                </li>
